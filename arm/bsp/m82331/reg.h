 ...
 *
 */
#define APB_VADDR(x)		(x)
#define COMCERTO_UEXP_DA_VADDR(x)		(x)
...
#define COMCERTO_SMC_BASE		0x10030000
#define COMCERTO_TDMA_BASE		0x10020000
#define COMCERTO_PHI_BASE		0x10010000
#define COMCERTO_TDM_BASE		0x10000000

/* Embedded memories and MSP SDRAM region */
...
#define PLL_FASTEN				(1<<27)
#define PLL_POWER				(1<<26)
#define PLL_BYPASS				(1<<25)
#define PLL_MUXSEL				(1<<24)
#define PLL_RESET				(1<<23)
#define PLL_CONTROL_MASK			0xFFC00000
